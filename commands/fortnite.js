...
module.exports.run = async (client, msg, args, config) => {
    if(cooldown.has(msg.author.id)) {
        ...
        fs.readFile('./accounts/fortnite.txt', 'utf8', function(err, data) {
            ...
            .addField('Here Is Your Fortnite Acc! ',`\n**${account}**`)
            .setColor("#363940")
            .setTimestamp();
...
module.exports.help = {
    name: `fortnite`,
    description: `Sends you a Fortnite acc `
};