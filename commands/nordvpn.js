...
module.exports.run = async (client, msg, args, config) => {
    if(cooldown.has(msg.author.id)) {
        ...
        fs.readFile('./accounts/nordvpn.txt', 'utf8', function(err, data) {
            ...
            .addField('Here Is Your NordVPN Acc! ',`\n**${account}**`)
            .setColor("#363940")
            .setTimestamp();
...
module.exports.help = {
    name: `NordVPN`,
    description: `Sends you a NordVPN acc `
};